                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-12">
                            ...
                            <button class="btn btn-secondary px-4 mx-auto float-right" onclick="location.href='owner_insert_activity.php'"><i class='fa fa-plus'></i> Add Activity</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                if (!empty($_POST["startTimeTxt"]) || !empty($_POST["endTimeTxt"]) || !empty($_POST["searchTxt"])) {
                    ...
                    //display activity in table
                        ...
                        for ($i = 0; $i < $count; $i++) {
                            ...
                            $edit_url = "owner_edit_activity.php?id=" . $NewsActivityID[$i];
                            echo "<tr>";
                            echo "<td>" . $i + 1 . "</td>";
