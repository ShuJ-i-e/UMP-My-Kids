                ...
                <div class="col-lg-10-m2">
                    ...
                    <div class="card border-0">
                        ...
                        <div class="card-body rounded-bottom bg-primary p-5">
                            <form action="registerCheck.php" method="post" name="form" class="form">
                                ...
                                <br>
                                <div class="form-group">
                                        <input type="text" name="phoneNumber" id="phoneNumber" class="form-control border-0 p-4" placeholder="Phone Number" />
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="address" id="address" class="form-control border-0 p-4" placeholder="Address" />
                                    </div>

                                    <div class="form-group">
                                        <input type="text" name="email" id="email" class="form-control border-0 p-4" placeholder="Email Address" />
                                    </div>
                                <div id="staff_div" style="display: none">
                                    ...
                                    <br>
                                    <div class="form-group">
                                        <textarea name="medicationHistory" class="form-control border-0 p-4" rows="6" placeholder="Medication History"></textarea>
                                    </div>
                                </div>
                                <br>
                                <br>
